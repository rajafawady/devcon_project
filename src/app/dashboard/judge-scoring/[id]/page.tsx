...
import { ScoringService } from '@/services/Services';
...
const JudgeScoringPanel = () => {
  ...
  const handleScoreSubmit = async (contestantId: string) => {
    await ScoringService.submitScore({
      performanceId: id as any,
      judgeId: user?.uid!,
      criteria: {
        pitch: currentScores.pitch,
        tone: currentScores.tone,
        stagePresence: currentScores.stagePresence,
        overall:
          currentScores.pitch + currentScores.tone + currentScores.stagePresence
      }
    });
        ...
        <CardContent className='space-y-6'>
          <div className='space-y-4'>
            ...
            <Button
              ...
              onClick={() => handleScoreSubmit(id as string)}
            >
              Submit Scores
            </Button>
          </div>
